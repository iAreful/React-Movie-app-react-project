...
function FavouriteMovies(props) {
	return (
		<div className='  bg-[#1D4289]  dark:bg-[#6B7787] p-4 rounded-xl my-4'>
			<SectiuonTitle title='Favourite Movies Collection' />
					...
					{props.chinema.map((movie, i) => (
						<SwiperSlide key={i}>
							<div
								...
								className='movie-poster relative w-48 h-64  bg-[#1D4289] rounded-xl overflow-hidden'>
								...
								<div className='add-fev absolute top-0 left-0 bg-slate-200   bg-opacity-90 rounded-xl w-48 py-4 '>
									<p className='text-lg text-center text-blue-400 dark:text-slate-800 font-bold '>
